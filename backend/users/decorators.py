...
def vendor_required(function=None):
    """Decorator for views that require vendor role"""
...
def can_create_product_required(function=None):
    """Decorator for views that require product creation permission"""
    actual_decorator = user_passes_test(
...
def can_manage_shop_required(function=None):
    """Decorator for views that require shop management permission"""
    actual_decorator = user_passes_test(
